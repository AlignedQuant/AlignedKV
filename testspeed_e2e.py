...
KV_Cache = QuantizedCache_AlignedKV(model.config, max_batch_size, max_cache_len, device, cache_dtype, reference=False, use_tensorcore=False)
# KV_Cache = DynamicCache()
# KV_Cache = StaticCache(model.config, max_batch_size, max_cache_len, device, cache_dtype)
